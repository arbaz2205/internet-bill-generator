...
function generateBill() {
  ...
  document.getElementById("bCustomerName").innerText =
    document.getElementById("customerName").value;

  document.getElementById("bCustomerAddress").innerText =
  ...
  rows.forEach((row, index) => {
    ...
    const amt = Number(row.cells[1].querySelector("input").value || 0);
